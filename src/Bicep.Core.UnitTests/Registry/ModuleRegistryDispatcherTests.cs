...
namespace Bicep.Core.UnitTests.Registry
{
    ...
    public class ModuleRegistryDispatcherTests
    {
        ...
        public void MockRegistries_ModuleLifecycle()
        {
            ...
            goodAvailabilityBuilder!.Should().HaveCodeAndSeverity("BCP192", DiagnosticLevel.Error);
            ...
            goodAvailabilityBuilder3!.Should().HaveCodeAndSeverity("BCP192", DiagnosticLevel.Error);
